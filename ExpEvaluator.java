...
public class ExpEvaluator {
 ...
 //Taken From Class Example
    ...
    public void fileEval(Scanner ee) {
        ...
        do
         {
            expEvaluator(ee.nextLine());  //Evaluates next line of file
...
//Tested
    ...
    public static void main(String[] args) throws IOException {
           ...
           System.out.println("Enter the filepath of the file you wish to evaluate:");
            String uInput =  path.nextLine();
            Scanner pathScanner = new Scanner(new FileInputStream(uInput));
